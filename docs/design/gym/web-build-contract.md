...
All authenticated boards inherit W1. Desktop shell is 1440 × 152, with 208px side insets at 1440 (1024px interior), 24px top padding, 40px rooms row, 16px gap and tabs at y80. Tabs are 50px high with 32px gaps. Narrow shell is 390 × 132 with 20px insets; rooms and tabs keep the same vertical positions. Active tab uses brand ink, inactive tabs faint ink. Pushed pages retain the tabs.

Content begins at y184 desktop and y164 narrow. Narrow content x16/w358. Desktop read-only and prose pages begin x208 with 640px reading measure; figures use 420px. The log uses a 1024px workspace. The routine editor uses 1092px: 640px movements +32px gap +420px targets, aligned x208 rather than centered independently. A back link is a 44px row before the title.

| Surface | Observed layout |
|---|---|
| Log selected 1440, `470:34` | Content x208/y184/w1024; workspace y341; index320 +24 gap +reader680; navigation44 high, reader y401 with 12px gaps. |
| Log default 390, `470:21` | Content x16/y164/w358, gap16; progress y355 before history y881. Progress cards gap24. History index is scrollable. Main footer action54 high. |
| Routine editor 1440, `475:1050` | Split y348, 640/32/420; ladder rows44 with4px gaps; content action band y773/h44. |
| Edit workout 1440, `482:1175` | Content x208/y184/w1024, section gaps32; editable form420; saved summary420 in right column; action band at content foot. |
| Coach 1440, `471:522` | Conversation x208/y184/w640; side rail x880/y184/w352; region gap16 and rail gap24. |
| Share setup 1440, `508:1353` | Content x208/y184; sections gap24; scope and update choices precede privacy panel and Preview. |
...
- Shared shell component descriptions `468:2`, `468:13`, and Gym Tab `4:7` now describe the current header tabs and narrow y164. The board status column records the current verified build state.
