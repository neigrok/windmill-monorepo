...
| **L4 · Product vocabulary** | the skill tree (radial + dagre), SkillNode / SkillConnector, kind × tier, the crown, halo & ember, TreePortrait, quests, AI assistance, fork & lineage, bark & leaf tokens, the plant/grow/unlock verbs | **never.** A sibling authors its own L4 and inherits L1–L3 whole. |
...
| The mobile priority ladder and gesture registry | AI assistance, quests, forking, the crown and the halo |
