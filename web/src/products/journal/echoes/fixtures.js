  ...
  return [
    {
      day: localDay(),
      entitled,
      matches: [5, 9, 14, 17, 20, 24, 27, 29, 31].map((back) => match(back)),
    },
    {
      day: daysBack(1),
      entitled,
      matches: [6, 18].map((back) => match(back)),
    },
    {
      day: dayOf(5),
      entitled,
      matches: [13, 14, 17, 20].map((back) => match(back)),
    },
  ];
}
...
export const SCENARIOS = [
  {
    id: 'free',
    label: 'Free — every passage in full',
    note: 'Nine complete echoes on tonight’s page, without a paid plan.',
    entitled: false,
    pagesWritten: 214,
    firstEchoEver: false,
    pages: corpusPages(),
  ...
  {
    id: 'one',
    label: 'With One — the same free echoes',
    note: 'The same nine passages, with the panel of all matches and the walk back through them.',
    entitled: true,
    pagesWritten: 214,
    firstEchoEver: false,
    pages: corpusPages(),
  ...
  },
  {
    ...
    firstEchoEver: true,
    pages: corpusPages(),
    echoes: [{ day: localDay(), entitled: true, matches: [match(14)] }],
  },
  {
    id: 'sparse',
