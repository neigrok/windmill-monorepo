  ...
  schema: [
    {
      ...
      'featureList': [
        ...
        'Speaks MCP so Claude, Cursor, or any agent can create and update a tree',
      ...
      'offers': [
        {
          ...
          'description': 'All of Windmill, free: as many trees as you like, up to 10,000 steps in each, private trees, the whole editor, paste import, sharing, forking, export, and the MCP server with an API key. Roadmap AI assistance is being redesigned. Its allowance is not announced yet.',
        },
      ],
