...
data class GymColors(
    ...
    val accentSoft = accent.copy(alpha = 0.2f)
    val weightInk = ink
...
object GymSkin {
    val Instrument = GymColors(
        ...
        inkFaint = Color(0xFF727771), setDone = Color(0xFF9AA859), prInk = Color(0xFFD9B04C), prSoft = Color(0x26D9B04C),
    ...
    val Daylight = GymColors(
        ...
        inkFaint = Color(0xFF625C58), setDone = Color(0xFF7D8C43), prInk = Color(0xFFA17822), prSoft = Color(0x24A17822),
