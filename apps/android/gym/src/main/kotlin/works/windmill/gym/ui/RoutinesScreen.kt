...
@Composable
fun RoutinesScreen(store: TrainingStore, onStart: (String) -> Unit) {
    ...
    Column(
        ...
        store.routines
            ...
            .forEach { routine -> RoutineTile(routine, store, nowMs, onStart) }
...
@Composable
private fun RoutineTile(routine: Routine, store: TrainingStore, nowMs: Long, onStart: (String) -> Unit) {
    Column(
        verticalArrangement = Arrangement.spacedBy(WindmillSpace.x3),
        modifier = Modifier
            .fillMaxWidth()
