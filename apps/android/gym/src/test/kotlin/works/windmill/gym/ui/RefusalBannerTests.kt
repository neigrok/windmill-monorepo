...
// The banner's words, held still. One function feeds the logger's banner and Today's, so the copy
// cannot fork between the two screens — and the claim-level line is the cross-platform pin: a
// lost document is said by NAME, "…couldn't be claimed", with the server's sentence under it.
