...
public struct GymSkin: Equatable {
    ...
    public static let instrument = GymSkin(
        canvas: Color(hex: 0x110C10),  // neutral-50
        surface: Color(hex: 0x1C171C),  // neutral-100, --surface-card
        raised: Color(hex: 0x262126),  // neutral-200
        sunken: Color(hex: 0x0C070B),  // --surface-sunken
        line: Color(hex: 0x262126),  // neutral-200
        lineStrong: Color(hex: 0x312C32),  // neutral-300
        ...
        weightInk: Color(hex: 0xF2EFEB),  // neutral-900
        ink: Color(hex: 0xF2EFEB),
        inkDim: Color(hex: 0xB7B4AF),  // neutral-600
        inkFaint: Color(hex: 0x797270),  // neutral-500
        ...
        warmupInk: Color(hex: 0x797270),
        unsyncedInk: Color(hex: 0x797270),
