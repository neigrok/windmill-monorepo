...
// quiet no-op and echoes simply do not appear. A real vendor or self-hosted model replaces this
// behind the same Embedder port; nothing else in the echo path moves.
