...
// The newest page of the log, welded to the lifter's first turn, exactly as `list_sessions` returns
// it.
...
// Reads the log, then drives the tool loop until the model stops asking for tools or the cap is hit.
