...
// the same seventeen declarations, the same owner scoping; what this adds is a model on our side of
// the wire and the bill that comes with it, which is why every gate below is read before the question
// travels anywhere.
//
