...
// `routine-id-taken` is repaired by minting a fresh id. `proposal-superseded` means the routine moved
// after the diff was computed, so the proposal is settled and there is nothing to retry.
