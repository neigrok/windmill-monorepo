...
// and the lifter reads the routine as it now stands — there is nothing to retry. `proposal-settled`
// means the other decision was already taken (an Apply on a dismissed proposal, or the reverse) and
// the screen has gone stale. Asking for the decision that WAS taken is not a refusal at all: it
