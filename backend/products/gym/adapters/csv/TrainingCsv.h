...
// By the time a row reaches here every value in it is already text (ExportedSet in
// ports/LogRepository.h says why), so the only thing left to decide is framing — and framing is all
// this file decides.
//
