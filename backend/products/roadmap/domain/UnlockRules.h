...
// never 500 on it. The honest cascade over dirt: a prerequisite that names no node is a
// prerequisite nobody has completed, so its dependant is locked; a cycle locks every member.
struct UnlockRules {
