...
// The two replies every JSON endpoint makes. An endpoint that wants a different shape (OAuth's
// RFC 6749 error object, the SSE stream's code-only frames) writes its own on purpose.
