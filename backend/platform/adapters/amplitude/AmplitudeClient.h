...
// session-resolved user (nullopt for a ghost) is the user_id. An empty API key makes every forward
// a no-op; the send is async and fire-and-forget, its failure only logged.
